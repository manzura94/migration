  ...
  return (
    <div className="menu__wrapper">
      {filteredProducts.map((el) => (
        <div
          key={el.id}
          className="menu__wrapper-item"
          onClick={() => handleSelectProduct(el.id)}
        >
          ...
          <div className="menu__wrapper-info">
            ...
            <div className="menu__price-container">
              {isLoggedIn &&
              (el.discountPrice !== undefined || el.discountPrice !== null) ? (
                <>
                  <span className="menu__price menu__price--old">
                    ${el.price}
                  </span>
                  <span className="menu__price menu__price--discount">
